        ...
        <div class="usr_men_items_outer">
            <div class="usr_men_items_inner">
                <div class="usr_men_cat_in">
                    <?php if(Auth::check()): ?>
                    <?php if(!Auth::user()->is_buyer_only): ?>
                        ...
                        <div class="usr_men_cat_body">
                            <div class="usr_men_quicks">
                                <div data-link="profile-setup/welcome" data-cat="" data-sub-cat="" class="usr_men_quick_each usr_men_setup_wizard">
                                    <img src="<?php echo e(asset('images/setup_recommend.gif')); ?>">
                    ...
                    <?php endif; ?>
                    <div data-cat="profile" class="usr_men_cat_each <?php echo e(isset($page)&&$page=='edit'?'pro_tb_active':''); ?>">
                        <div class="usr_men_cat_head">
                            My Website
                        </div>
                        <div class="usr_men_cat_body">
                    ...
                    <div data-cat="media" class="usr_men_cat_each <?php echo e(isset($page)&&$page=='media'?'pro_tb_active':''); ?>">
                        <div class="usr_men_cat_head">
                            My Music
                        </div>
                        <div class="usr_men_cat_body">
                    ...
                    <div data-cat="orders" class="usr_men_cat_each <?php echo e(isset($page)&&$page=='orders'?'pro_tb_active':''); ?>">
                        <div class="usr_men_cat_head">
                            My Finances
                        </div>
                        <div class="usr_men_cat_body">
                    ...
                    <div data-cat="tools" class="usr_men_cat_each <?php echo e(isset($page)&&$page=='tools'?'pro_tb_active':''); ?>">
                        <div class="usr_men_cat_head">
                            Artist Tools
                        </div>
                        <div class="usr_men_cat_body">
                    ...
                    <div data-cat="crowdfunds" class="usr_men_cat_each <?php echo e(isset($page)&&$page=='crowdfunds'?'pro_tb_active':''); ?>">
                        <div class="usr_men_cat_head">
                            Crowdfunding
                        </div>
                        <div class="usr_men_cat_body">
                    ...
                    <div data-cat="chat" class="usr_men_cat_each <?php echo e(isset($page)&&$page=='chat'?'pro_tb_active':''); ?>">
                        <div class="usr_men_cat_head">
                            Networking
                        </div>
                        <div class="usr_men_cat_body">
                            <div class="usr_men_quicks">
                                ...
                                <?php if(Auth::user()->expert && Auth::user()->apply_expert == 2): ?>
                    ...
                    <div class="usr_men_cat_each usr_men_logout">
                        <a href="<?php echo e(route('logout')); ?>" class="usr_men_cat_head">
    ...
    </script><?php /**PATH /opt/lampp/htdocs/platform/resources/views/parts/smart-user-menu.blade.php ENDPATH**/ ?>