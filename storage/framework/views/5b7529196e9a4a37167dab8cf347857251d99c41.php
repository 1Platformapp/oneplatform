	...
	<script defer src="<?php echo e(asset('audio-player/wavesurfer.min.js')); ?>"></script>
    <script defer src="<?php echo e(asset('audio-player/play.min.js')); ?>"></script>
    ...
    <div class="ap_outer">
        <div class="ap_inner">
            ...
            <div class="only_player">
                <div class="ap_left">
                    <img alt="Audio music file <?php echo e(isset($user) ? 'from '.$user->name : ''); ?>" class="ap_track_banner defer_loading" src="#" data-src="<?php echo e(asset('images/auditiontv.jpg?v=1.1')); ?>">
                </div>
    ...
    </div><?php /**PATH /opt/lampp/htdocs/platform/resources/views/parts/audio-player.blade.php ENDPATH**/ ?>