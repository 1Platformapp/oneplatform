<?php $chartUser = Auth::check() ? Auth::user() : NULL ?>
...
<div class="pro_soc_con_face_outer pro_page_pop_up clearfix" style="z-index: 10;" id="chart-sharing-popup-old">
    ...
    <div class="pro_soc_con_face_inner clearfix">
        ...
        <div class="pro_submit_button_outer soc_con_submit_success clearfix" style="background: #fff;">
            ...
            <img alt="image popup" class="prevent_pre_loading" src="#" data-src="<?php echo e(asset("img/facebook_share.png")); ?>" style="display: inline-block; width: 35px; padding-right: 10px; cursor: pointer;" onclick="return facebookShare('video')">
            <img alt="image popup" class="prevent_pre_loading" src="#" data-src="<?php echo e(asset("img/google_share.png")); ?>" style="display: inline-block; padding-right: 10px; cursor: pointer;" onclick="return googleShareVideo()">
            <img alt="image popup" class="prevent_pre_loading" src="#" data-src="<?php echo e(asset("img/twitter_share.png")); ?>" style="display: inline-block; width: 25px; cursor: pointer;" onclick="return twitterShare('video')">
        </div>
    </div>
</div>
<!-- Connect Facebook Account  !-->
...
<div class="pro_soc_con_face_outer pro_page_pop_up clearfix" id="chart-sharing-popup">
    ...
    <div class="pro_soc_con_face_inner clearfix">
        ...
        <div class="pro_submit_button_outer soc_con_submit_success clearfix" style="background: #fff;">
            ...
            <img alt="image popup" class="prevent_pre_loading" src="#" data-src="<?php echo e(asset("images/share_to_fb.png")); ?>" onclick="return facebookShare('video')">
            <img alt="image popup" class="prevent_pre_loading" src="#" data-src="<?php echo e(asset("images/share_to_twitter.png")); ?>" onclick="return twitterShare('video')">
        </div>
    </div>
</div>
...
<div class="pro_soc_con_face_outer pro_page_pop_up clearfix" style="z-index: 10;" id="user-follow-popup">
    <div class="pro_soc_con_face_inner clearfix">
        ...
        <?php if(Auth::check() && isset($user) && $user && Auth::user()->isFollowerOf($user)): ?>
        ...
        <?php elseif(Config('constants.primaryDomain') == $_SERVER['SERVER_NAME']): ?>
        <div class="follow_authenticator <?php echo e(Auth::check()?'instant_hide':''); ?>">
            <div class="soc_con_face_username clearfix">
            ...
            <div class="header3">Don't have an account? <a href="<?php echo e(route('register')); ?>">Signup</a></div>
        </div>
        <div class="follow_go_ahead <?php echo e(Auth::check()?'':'instant_hide'); ?>">
            <div class="soc_con_face_username clearfix">
    ...
    <div class="pro_soc_con_face_inner clearfix">
        ...
        <div class="project_fill_form instant_hide">
            ...
            <div class="pro_fill_img clearfix">
                <img alt="image popup" class="prevent_pre_loading" src="#" data-src="<?php echo e(asset('images/pupfillprofile.png')); ?>">
            </div>
        </div>
    ...
    <div class="pro_soc_con_face_inner clearfix">
        ...
        <div class="stage_one">
            ...
            <div class="pro_pop_dark_note">
                <a class="inline_info" data-title="1 Platform: World's first bespoke licensing" href="https://www.youtube.com/embed/EksAIXYMEow?autoplay=0&origin=<?php echo e(config('constants.primaryDomain')); ?>&rel=0">How do license proposals work?</a>
            </div>
        </div>
        <div class="stage_two instant_hide">
            <div class="soc_con_face_username clearfix">
                <div class="pro_pop_text_light">
                    Your proposal has been sent to <span class="pro_text_dark" id="sender_name"></span>. Go to <a href="<?php echo e(route('profile.with.tab', ['tab' => 'chat'])); ?>" class="pro_text_dark">chat</a> to read replies or send more messages/details about your proposal.
                </div>  
            </div>
            <br>
        </div>
...
<div class="pro_page_pop_up clearfix" id="chat_message_popup">
    ...
    <div class="pro_soc_con_face_inner clearfix">
        ...
        <div class="stage_one">
            ...
            <br>
            <div class="pro_pop_dark_note">
                <a class="inline_info" data-title="1 Platform: World's first bespoke licensing" href="https://www.youtube.com/embed/EksAIXYMEow?autoplay=0&origin=<?php echo e(config('constants.primaryDomain')); ?>&rel=0">How chat works?</a>
            </div>
        </div>
        <div class="stage_two instant_hide">
            <div class="soc_con_face_username clearfix">
                <div class="pro_pop_text_light">
                    Your message has been sent to <span class="pro_text_dark" id="sender_name"></span>. Go to <a href="<?php echo e(route('profile.with.tab', ['tab' => 'chat'])); ?>" class="pro_text_dark">chat</a> to read replies or send more messages.
                </div>  
            </div>
            <br>
        </div>
        ...
        <div class="pay_item_details">
            <div class="pay_item_details_left">
                <div class="pay_item_thumb">
                    <img alt="Default thumbnail for item" src="<?php echo e(asset('images/0011ff.png')); ?>">
                </div>
            </div>
        ...
        <div class="stage_one">
            <div class="soc_con_face_username clearfix">
                ...
                <div class="pro_pop_multi_row">
                    <div class="each_col">
                        <input class="dummy_field" type="text" name="fakeusernameremembered">
                        <input placeholder="Your Name" type="text" id="pay_quick_name" value="<?php echo e($chartUser ? $chartUser->name : ''); ?>" />
                    </div>
                    <div class="each_col">
                        <input class="dummy_field" type="text" name="fakeusernameremembered">
                        <input placeholder="Your Email" type="text" id="pay_quick_email" value="<?php echo e($chartUser ? $chartUser->email : ''); ?>">
                    </div>
                </div>
                <div class="pro_pop_multi_row">
                    <div class="each_col">
...
<div class="pro_page_pop_up clearfix" id="sub_paypal_info">
    ...
    <div class="pro_soc_con_face_inner clearfix">
        <div class="soc_con_top_logo clearfix">
            <a style="opacity:0;" class="logo8">
                <img class="pro_soc_top_logo defer_loading" src="" data-src="<?php echo e(asset('images/1logo8.png')); ?>"><div>Platform</div>
            </a>
            <i class="fa fa-times pro_soc_top_close"></i>
        </div>
        <div class="stage_one">
        	<form action="<?php echo e(isset($user) ? route('paypal.subscribe', ['id' => $user->id]) : ''); ?>" method="post">
...
</div><?php /**PATH /opt/lampp/htdocs/platform/resources/views/parts/chart-popups.blade.php ENDPATH**/ ?>