                                ...
                                <tr>
                                    ...
                                    <td style="width: 90%;">
                                        ...
                                        <table style="width:100%" width="100%" cellspacing="0" cellpadding="0" border="0">
                                            ...
                                            <tr>
                                                <td style="color:#8c8c8c;font-family:Open Sans,sans-serif;font-weight: 500;font-size:12px">
                                                    
                                                    <span style="color:#fc064c;">{{$user->name}}</span>
                                                    has recently uploaded a music with license and requires your approval.<br><br>
                                                    Email: {{$user->email}}<br>
                                                    Username: {{$user->username}}<br>
                                                    Contact Number: {{$user->contact_number && $user->contact_number != '' ? $user->contact_number : 'None'}}<br>
                                                    Link: <a href="{{route('user.home', ['params' => $user->username])}}">Home</a>
                                                </td>
                                            </tr>
