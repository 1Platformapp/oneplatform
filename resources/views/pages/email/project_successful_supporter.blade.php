                                        ...
                                        <table style="width:100%" width="100%" cellspacing="0" cellpadding="0" border="0">
                                            ...
                                            <tr>
                                                <td style="color:#30819c;font-family:Helvetica,Arial,sans-serif;font-size:16px;text-align: center;">
                                                    A project you supported has reached its goal!!!
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <?php $email = explode('@', $user->email); ?>
                                                    <a href="{{ $asset . '/' . $email[0] }}"><img style="width: 100%;" src="{{$asset.'/email-template-images/image_check_out_project_button.png'}}"></a>
                                                </td>
                                            </tr>
