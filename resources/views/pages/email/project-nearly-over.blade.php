                                ...
                                <tr>
                                    ...
                                    <td style="width: 90%;">
                                        ...
                                        <table style="width:100%" width="100%" cellspacing="0" cellpadding="0" border="0">
                                            ...
                                            <tr>
                                                <td style="font-family:Open Sans,sans-serif;font-weight: normal;font-size:13px;" align="center">
                                                    <a style="color: #fff;font-family:Open Sans,sans-serif;font-weight: 500;font-size:13px;text-decoration: none;" href="{{route('user.project', ['username' => $user->username])}}">
                                                        <img height="100" src="{{asset('percent-images/'.$campaign->daysLeft().'.png')}}">
                                                    </a>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="line-height: 0;" height="10">&nbsp;</td>
                                            </tr>
                                            <tr>
                                                <td style="color:#999999;font-family:Open Sans,sans-serif;font-weight: normal;font-size:18px;" align="center">
                                            ...
                                            <tr>
                                                <td style="color:#fc064c;font-family:Open Sans,sans-serif;font-weight: 600;font-size:13px;" align="center">
                                                    Make sure everyone knows about your project so you can reach your goal
                                                </td>
                                            </tr>
                                            <tr>
                                                <td height="30">&nbsp;</td>
