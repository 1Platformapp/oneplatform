                                        ...
                                        <table style="width:100%" width="100%" cellspacing="0" cellpadding="0" border="0">
                                            ...
                                            <tr>
                                                <td style="color:#999999;font-family:Open Sans,sans-serif;font-weight: 500;font-size:13px">
                                                    The Project you supported will finish soon. Help this project become a reality by sharing the project page.
                                                </td>
                                            </tr>
                                            ...
                                            @php $videoId = $campaign->project_video_url != '' ? $commonMethods->getYoutubeVideoId($campaign->project_video_url) : '' @endphp
                                            <tr>
                                                <td style="font-family:Open Sans,sans-serif;font-weight: normal;font-size:13px;" align="center">
                                                    <a style="color: #fff;font-family:Open Sans,sans-serif;font-weight: 500;font-size:13px;text-decoration: none;" href="{{route('user.project', ['username' => $user->username])}}">
                                            ...
                                            <tr>
                                                <td align="center" style="cursor: pointer; padding: 3px;background: #737373;color: #fff;font-family: Open Sans,sans-serif;border-radius: 5px;font-size: 14px;">
                                                    <a style="color: #fff;text-decoration: none;" href="{{route('user.project', ['username' => $user->username])}}">
                                                    Buy More Bonuses   
                                                    </a>                   
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td align="center" style="cursor: pointer; padding: 3px;background: #737373;color: #fff;font-family: Open Sans,sans-serif;border-radius: 5px;font-size: 14px;">
                                                    <a style="color: #fff;text-decoration: none;" href="{{route('user.project.auto.share', ['userId' => $user->id, 'type' => 'twitter_url'])}}">
