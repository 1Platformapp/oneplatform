                                        ...
                                        <table style="width:100%" width="100%" cellspacing="0" cellpadding="0" border="0">
                                            ...
                                            <tr>
                                                <td style="font-family:Open Sans,sans-serif;font-weight: 500;font-size:17px;">
                                                    <span style="color:#fc064c;">Hi</span>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td style="color:#8c8c8c;font-family:Open Sans,sans-serif;font-weight: 500;font-size:11px">
                                                    New registration request from <span style="color:#fc064c;">{{ $user->name }}</span>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td style="font-family:Open Sans,sans-serif;font-weight: normal;font-size:13px; padding-bottom: 24px;" align="left">
                                                    <span style="width: 70%; color:#8c8c8c; float: left;">Name<br>
                                                    </span>
                                            ...
                                            <tr>
                                                <td style="font-family:Open Sans,sans-serif;font-weight: normal;font-size:13px; padding-bottom: 24px;" align="left">
                                                    <span style="width: 70%; color:#8c8c8c; float: left;">Email<br>
                                                    </span>
                                                    <span style="color:#8c8c8c; float: right;">
                                                        {{$user->email}} 
                                                    </span>
                                            ...
                                            <tr>
                                                <td style="font-family:Open Sans,sans-serif;font-weight: normal;font-size:13px; padding-bottom: 24px;" align="left">
                                                    <span style="width: 70%; color:#8c8c8c; float: left;">Contact Number
                                                    </span>
                                                    <span style="color:#8c8c8c; float: right;">
                                                        {{$user->contact_number}} 
                                                    </span>
                                            ...
                                            <tr>
                                                <td style="font-family:Open Sans,sans-serif;font-weight: normal;font-size:13px; padding-bottom: 24px;" align="left">
                                                    <span style="width: 70%; color:#8c8c8c; float: left;">Music URL
                                                    </span>
                                                    <span style="color:#8c8c8c; float: right;">
                                                        {{$user->music_url}} 
                                                    </span>
                                                    ...
                                                    <table cellspacing="0" cellpadding="0" border="0" align="center">
                                                        ...
                                                        <tr>
                                                            <td style="color:#8c8c8c;font-family:Open Sans,sans-serif;font-weight: 500;font-size:10px;width:100%;" align="center">
                                                                To approve or decline this request click <a style="text-decoration: none;" href="http://duong.1platform.tv/admin"><span style="color:#fc064c;">here</span></a> in login as admin
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
