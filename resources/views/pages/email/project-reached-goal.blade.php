                                ...
                                <tr>
                                    ...
                                    <td style="width: 90%;">
                                        ...
                                        <table style="width:100%" width="100%" cellspacing="0" cellpadding="0" border="0">
                                            ...
                                            @php $videoId = $commonMethods->getYoutubeVideoId($campaign->project_video_url) @endphp
                                            <tr>
                                                <td style="font-family:Open Sans,sans-serif;font-weight: normal;font-size:13px;" align="center">
                                                    <a style="color: #fff;font-family:Open Sans,sans-serif;font-weight: 500;font-size:13px;text-decoration: none;" href="{{route('user.project', ['username'=>$campaign->user->username,'load_campaign'=>$campaign->id])}}">
                                            ...
                                            <tr>
                                                <td align="center" style="cursor: pointer; padding: 3px;background: #737373;color: #fff;font-family: Open Sans,sans-serif;border-radius: 5px;font-size: 14px;">
                                                    <a style="color: #fff;text-decoration: none;" href="{{route('user.project', ['username'=>$campaign->user->username,'load_campaign'=>$campaign->id])}}">
