                                        ...
                                        <table style="width:100%" width="100%" cellspacing="0" cellpadding="0" border="0">
                                            ...
                                            <tr>
                                                <td style="color:#8c8c8c;font-family:Open Sans,sans-serif;font-weight: 500;font-size:11px">
                                                    Thank you for you application to be part of our agents team in your closest city. <br>Currently we have all our agent slots taken, when a suitable position becomes available for you, we have all your details and will contact you. <br><br>Thank you for your approach and look forward to 1platform being home of your Music. <br><br>1platform Team
                                                </td>
                                            </tr>
                                                    ...
                                                    <table cellspacing="0" cellpadding="0" border="0" align="center">
                                                        ...
                                                        <tr>
                                                            <td style="color:#8c8c8c;font-family:Open Sans,sans-serif;font-weight: 500;font-size:10px;width:100%;" align="center">
                                                                To view our agents go to <a style="text-decoration: none;" href="{{route('live')}}"><span style="color:#fc064c;">1platform Agents</span></a>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
