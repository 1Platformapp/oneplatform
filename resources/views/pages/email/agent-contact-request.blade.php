...
<div bgcolor="#E5EDF6" style="background:#f6f5f2;margin-top:0;margin-right:0;margin-bottom:0;margin-left:0;padding-top:0;padding-right:0;padding-bottom:0;padding-left:0">
    ...
    @php $userDetails = \App\Http\Controllers\CommonMethods::getUserRealDetails($user->id) @endphp
                                        ...
                                        <table style="width:100%" width="100%" cellspacing="0" cellpadding="0" border="0">
                                            ...
                                            <tr>
                                                <td style="font-family:Open Sans,sans-serif;font-weight: 500;font-size:17px;">
                                                    <span style="color:#fc064c;">Hi {{ $agent->name }}</span>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td style="color:#8c8c8c;font-family:Open Sans,sans-serif;font-weight: 500;font-size:11px">
                                                    <span style="color:#fc064c;">{{$user->name}}</span>
                                                     wants to join your network agency at 1Platform
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td style="font-family:Open Sans,sans-serif;font-weight: normal;font-size:11px; padding-bottom: 28px;" align="left">
                                                    <span style="color:#818181; float: left;">Name</span>
                                                    <span style="color:#818181; float: right;">{{$user->name}} </span>
                                                </td>
                                            </tr>

                                            <tr>
                                                <td style="font-family:Open Sans,sans-serif;font-weight: normal;font-size:11px; padding-bottom: 28px;" align="left">
                                                    <span style="color:#818181; float: left;">Email</span>
                                                    <span style="color:#818181; float: right;">{{$user->email}}</span>
                                                </td>
                                            </tr>

                                            <tr>
                                                <td style="font-family:Open Sans,sans-serif;font-weight: normal;font-size:11px; padding-bottom: 28px;" align="left">
                                                    <span style="color:#818181; float: left;">Skill</span>
                                                    <span style="color:#818181; float: right;">{{$userDetails['skills']}}</span>
                                                </td>
                                            </tr>

                                            <tr>
                                                <td style="font-family:Open Sans,sans-serif;font-weight: normal;font-size:11px; padding-bottom: 28px;" align="left">
                                                    <span style="color:#818181; float: left;">Address</span>
                                                    <span style="color:#818181; float: right;">{{$userDetails['address']}}</span>
                                                </td>
                                            </tr>

                                            <tr>
                                                <td style="font-family:Open Sans,sans-serif;font-weight: normal;font-size:11px; padding-bottom: 28px;" align="left">
                                                    <span style="color:#818181; float: left;">City </span>
                                                    <span style="color:#818181; float: right;">{{$userDetails['city']}}</span>
                                                </td>
                                            </tr>

                                            <tr>
                                                <td style="font-family:Open Sans,sans-serif;font-weight: normal;font-size:11px; padding-bottom: 28px;" align="left">
                                                    <span style="color:#818181; float: left;">Postcode </span>
                                                    <span style="color:#818181; float: right;">{{$userDetails['postcode']}}</span>
                                                </td>
                                            </tr>
