                                        ...
                                        <table style="width:100%" width="100%" cellspacing="0" cellpadding="0" border="0">
                                            ...
                                            <tr>
                                                <td style="color:#30819c;font-family:Helvetica,Arial,sans-serif;font-size:16px;text-align: center;">
                                                    Your project ended on <span style="color:#f95753;">{{ date('d/m/y') }}</span>.However your project did not hit your target goal.
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td style="color:#30819c;font-family:Helvetica,Arial,sans-serif;font-size:16px;text-align: center;">
                                                    The funds for your project will be returned to your project supporters.
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td style="color:#30819c;font-family:Helvetica,Arial,sans-serif;font-size:16px;text-align: center;">
                                                    When starting a new project you can do something completely new.
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td style="color:#30819c;font-family:Helvetica,Arial,sans-serif;font-size:16px;text-align: center;">
                                                    It's up to you what you do, a new exciting idea will always attract followers.
                                                </td>
                                            </tr>
