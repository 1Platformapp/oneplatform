                                        ...
                                        <table style="width:100%" width="100%" cellspacing="0" cellpadding="0" border="0">
                                            ...
                                            <tr>
                                                <td style="color:#8c8c8c;font-family:Open Sans,sans-serif;font-weight: 500;font-size:11px">
                                                    You have been added by <span style="color:#fc064c;">{{ $participant->calendarEvent->creator->name }}</span> for the following upcoming event
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td style="color:#8c8c8c;font-family:Open Sans,sans-serif;font-weight: 500;font-size:11px">
                                                    Event Title: {{ $participant->calendarEvent->title }}
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td style="color:#8c8c8c;font-family:Open Sans,sans-serif;font-weight: 500;font-size:11px">
                                                    Event date and time: {{ $participant->calendarEvent->date_time_input ? $participant->calendarEvent->date_time_input : date('d/m/Y', strtotime($participant->calendarEvent->date)) }}
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td style="color:#8c8c8c;font-family:Open Sans,sans-serif;font-weight: 500;font-size:11px">
                                                    Event location: {{ $participant->calendarEvent->location }}
                                                </td>
                                            </tr>
