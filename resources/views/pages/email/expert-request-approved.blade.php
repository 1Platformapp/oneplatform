                                        ...
                                        <table style="width:100%" width="100%" cellspacing="0" cellpadding="0" border="0">
                                            ...
                                            <tr>
                                                <td style="color:#8c8c8c;font-family:Open Sans,sans-serif;font-weight: 500;font-size:11px">
                                                    Your request to be an agent on 1platform has been 
                                                    <span style="color:#fc064c;">approved</span> over the following terms
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td style="color:#8c8c8c;font-family:Open Sans,sans-serif;font-weight: 500;font-size:11px">
                                                    <span style="color:#fc064c;">Your Commission:</span>{{$user->expert->commission}}%
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td style="color:#8c8c8c;font-family:Open Sans,sans-serif;font-weight: 500;font-size:11px">
                                                    <span style="color:#fc064c;">Additional Terms:</span><br>{{nl2br($user->expert->terms)}}
                                                </td>
                                            </tr>
                                                    ...
                                                    <table cellspacing="0" cellpadding="0" border="0" align="center">
                                                        ...
                                                        <tr>
                                                            <td style="color:#8c8c8c;font-family:Open Sans,sans-serif;font-weight: 500;font-size:10px;width:100%;" align="center">
                                                                To view yourself go to <a style="text-decoration: none;" href="{{route('live')}}"><span style="color:#fc064c;">1platform Agents</span></a>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
