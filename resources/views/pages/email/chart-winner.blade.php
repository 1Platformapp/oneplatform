                                ...
                                <tr>
                                    ...
                                    <td style="width: 90%;">
                                        ...
                                        <table style="width:100%" width="100%" cellspacing="0" cellpadding="0" border="0">
                                            ...
                                            <tr>
                                                <td style="color: #818181;font-family:Open Sans,sans-serif;font-weight: normal;font-size:15px;" align="center">
                                                    Well done! <span style="font-weight: 600;">You Have Won 1Platform Chart</span>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td align="center">
                                                    <img src="{{asset('email-template-images/new/Asset%2046.png')}}">
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td style="color: #fc064c;font-family:Open Sans,sans-serif;font-weight: 600;font-size:16px;" align="center">
                                                    Share Your Success On 1Platform Chart!
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td align="center" style="cursor: pointer; padding: 3px;background: #737373;color: #fff;font-family: Open Sans,sans-serif;border-radius: 5px;font-size: 15px;">
                                                    <a style="color: #fff;text-decoration: none;" href="{{route('chart.auto.share', ['type' => 'facebook_url'])}}">
                                            ...
                                            <tr>
                                                <td align="center" style="cursor: pointer; padding: 3px;background: #737373;color: #fff;font-family: Open Sans,sans-serif;border-radius: 5px;font-size: 14px;">
                                                    <a style="color: #fff;text-decoration: none;" href="{{route('chart.auto.share', ['type' => 'twitter_url'])}}">
