                    ...
                    <tbody>
                        <tr>
                            <td style="text-align:left" align="left">
                                <a href="{{ route('home') }}">
                                    <img width="140" src="{{ asset('images/1logo5.png') }}" style="border:none" class="CToWUd" border="0">
                                </a>
                            </td>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td style="color:#9daec3;font-family:Helvetica,Arial,sans-serif;font-size:60px" align="center">
                                                                <span>
                                                                    {{$currencySymbol.(number_format($bonusTotal+$donationTotal+$deliveryCost, 2))}}
                                                                </span>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                          <td style="color:#9daec3;font-family:Helvetica,Arial,sans-serif;font-size:16px" align="center">
                                                            You just received {{$currencySymbol.(number_format($bonusTotal+$donationTotal+$deliveryCost, 2))}} support from
                                                          </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td style="font-family:Helvetica,Arial,sans-serif;font-size:16px;" align="center">
                                                                <a href="#" style="text-decoration:none;text-decoration:none!important" target="_blank" data-saferedirecturl=""><span style="color:#f95753;">{{$buyerUser->name}}</span></a>
                                                            </td>
                                                        </tr>
...
<td style="width:100%" valign="middle" height="52" align="center">
                                                                                                    ...
                                                                                                    <a href="{{ asset('profile?page=orders&email_user=' . $sellerUser->id) }}" style="text-decoration:none" target="_blank" data-saferedirecturl=""><img src="{{ asset('email-template-images/thanks-button-with-alfie.png') }}" style="width: 300px;"></a>
										...
										<?php $email = explode("@", $sellerUser->email)?>
                                                                                <table style="width:100%;max-width:320px" cellspacing="0" cellpadding="0" border="0" align="center">
                                                                                    <tbody>
                                                                                        <tr>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td style="color:#9daec3;font-family:Helvetica,Arial,sans-serif;line-height:25px;font-size:14px;text-align:center">
                                                                ...
                                                                <span style="color:#9daec3;">Your project is here<span> <a href="" style="color:#f95753;font-family:Helvetica,Arial,sans-serif;line-height:25px;font-size:14px;text-decoration:none;text-decoration:none!important" target="_blank" data-saferedirecturl=""></span></a><br>
