                                        ...
                                        <table style="width:100%" width="100%" cellspacing="0" cellpadding="0" border="0">
                                            ...
                                            <tr>
                                                <td style="font-family:Open Sans,sans-serif;font-weight: 500;font-size:17px;">
                                                    <span style="color:#fc064c;">Hi {{ $stripeCheckout->customer->name }}</span>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td style="color:#8c8c8c;font-family:Open Sans,sans-serif;font-weight: 500;font-size:11px">
                                                    ...
                                                    <span style="color:#fc064c;">{{$stripeCheckout->amount}} {{strtoupper($stripeCheckout->currency)}}</span> 
                                                    has failed to reach to
                                                    <span style="color:#fc064c;">{{$stripeCheckout->user->name}}</span> 
                                                    with a decline code 
                                                    <span style="color:#fc064c;">{{$stripeCheckout->error}}</span><br><br>
                                                     Please <a href="{{route('login')}}">login</a> to your 1platform account then click the retry button below to let us help you complete any missing information or authentication in this payment
                                                     <br><br>
                                                     <tr>
                                                         <td height="22">&nbsp;</td>
                                                     </tr>
                                                     <tr>
                                                        <td align="center" style="cursor: pointer; padding: 3px;background: #737373;color: #fff;font-family: Open Sans,sans-serif;border-radius: 5px;font-size: 14px;">
                                                            <a style="color: #fff;text-decoration: none;" href="{{route('payment.failed.retry', ['id' => $stripeCheckout->id])}}">
                                                            Retry Payment
                                                            </a>                       
                                                        </td>
