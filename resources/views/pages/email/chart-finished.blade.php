                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 90%;">
                                                ...
                                                <table style="width:100%" width="100%" cellspacing="0" cellpadding="0" border="0">
                                                    ...
                                                    <tr>
                                                        <td style="color: #fc064c;font-family:Open Sans,sans-serif;font-weight: normal;font-size:14px;" align="left">
                                                            Well done! <span style="font-weight: 600;">Your cover was {{$rank}} in the chart</span>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td style="color: #818181;font-family:Open Sans,sans-serif;font-weight: normal;font-size:13px;" align="left">
                                                            Enter next week to see if you can win 1Platform Chart
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td style="color: #fc064c;font-family:Open Sans,sans-serif;font-weight: 600;font-size:13px;" align="left">
                                                            Share your position on 1Platform Chart!
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td align="center" style="cursor: pointer; padding: 3px;background: #737373;color: #fff;font-family: Open Sans,sans-serif;border-radius: 5px;font-size: 14px;">
                                                            <a style="color: #fff;text-decoration: none;" href="">
                                                            <img style="width: 14px;" src="{{asset('images/tw_icon.png')}}"> 
                                                                Tweet     
                                                            </a>                     
                                                        </td>
                                                    </tr>
