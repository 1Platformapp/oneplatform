...
@section('pagetitle') Record Song Unplugged - Recording Studio Manchester @endsection

@section('pagedescription')
	
	<meta name="description" content="The Unplugged Package lets you sit with our musician as they record your favourite track on guitar or piano. After this you will record your vocals in a professional recording booth, then it's off to the mixer room to mix and master your song" />
		...
		<div class="item_container tot_awe_pro_outer">
		    <div class="item_top tot_awe_pro_left ">
		        <div class="item_thumb user_product_img_thumb">
		            <img alt="Unplugged Package to record a song" src="{{$commonMethods::getUserProductThumbnail($product->id)}}">
		        </div>
		    </div>
		    <div class="item_bottom tot_awe_pro_right">
		        <div class="item_info_box">
		            <div class="item_title">
		                <h1>Record a song unplugged</h1>
		            </div>
		        </div>
		        ...
		        <section class="item_desc_each item_desc_expandable">
		            ...
		            <p class="item_desc_body">
		                The Unplugged Package lets you sit with our musician as they record your favourite track on guitar or piano. After this you will record your vocals in a professional recording booth, then it's off to the mixer room to mix and master your song. 
		            </p><br>
		            <p class="item_desc_body">
		                Go on chose a song and make it simple sweet and better than the original!
		            </p><br>
		            <p class="item_desc_body">
