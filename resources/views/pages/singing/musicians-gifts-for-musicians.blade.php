...
@section('pagetitle') Musician Recording - Dream Package - Recording Studio Manchester @endsection

@section('pagedescription')
	
	<meta name="description" content="Whether you are a classical pianist player or a lover of modern keyboard sounds, why not capture your artistic skill with a recording session?! Our fully equipped Live Lounge has everything a perfomer needs. Our full package includes sole use of the recording studio, hands-on mixing experience, advice from top engineers, a photo shoot and finished CD" />
		...
		<div class="item_container tot_awe_pro_outer">
		    <div class="item_top  tot_awe_pro_left ">
		        <div class="item_thumb user_product_img_thumb ">
		            <img alt="All musicians are invited to record their songs for 2 hr (Musicians Dream Package)" src="{{$commonMethods::getUserProductThumbnail($product->id)}}">
		        </div>
		    </div>
		    <div class="item_bottom tot_awe_pro_right">
		        <div class="item_info_box">
		            <div class="item_title">
		                <h1>Musician Recording Package (Musicians Dream Package)</h1>
		            </div>
		        </div>
		        ...
		        <section class="item_desc_each item_desc_expandable">
		            ...
		            <p class="item_desc_body">
		                Whether you are a classical pianist player or a lover of modern keyboard sounds, why not capture your artistic skill with a recording session?! Our fully equipped Live Lounge has everything a perfomer needs. Our full package includes sole use of the recording studio, hands-on mixing experience, advice from top engineers, a photo shoot and finished CD. 
		            </p>
		        </section>
