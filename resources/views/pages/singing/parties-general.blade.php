...
@section('pagetitle') Exciting Packages For Parties - Recording Studio Manchester @endsection

@section('pagedescription')
	
	<meta name="description" content="Our recording studio experiences offer one of the ultimate party experiences. Give your children, work collages or wedding parties the day to remember, that gift experience that will truly blow them away along with a unique and personal souvenir that they will treasure forever. Here at the Cotyso Experience, we can provide an unforgettable adventure that will both delight and thrill!" />
...
@section('page-content')
		...
		<div class="item_container tot_awe_pro_outer">
		    <div class="item_top  tot_awe_pro_left ">
		        <div class="item_thumb user_product_img_thumb ">
		            <img alt="Singing experience has nation wide studios for parties" src="{{asset('images/singing/parties.jpg')}}">
		        </div>
		    </div>
		    <div class="item_bottom tot_awe_pro_right">
		        <div class="item_info_box">
		            <div class="item_title">
		                <h1>Singing Experience Offers Exciting Packages for Parties</h1>
		            </div>
		        </div>
		        <div class="item_desc_each item_desc_expandable">
		            <h2 class="item_desc_head">Introduction</h2>
		            <p class="item_desc_body">
		                Scroll down to check out our best packages for parties
					</p><br>
		            <p class="item_desc_body">
		                Our recording studio experiences offer one of the ultimate party experiences. Give your children, work collages or wedding parties the day to remember, that gift experience that will truly blow them away along with a unique and personal souvenir that they will treasure forever. Here at the Cotyso Experience, we can provide an unforgettable adventure that will both delight and thrill!
		            </p><br>
		            <p class="item_desc_body">
	...
	@php $products = \App\Models\UserProduct::whereIn('id', [182,183,184,185])->get() @endphp
