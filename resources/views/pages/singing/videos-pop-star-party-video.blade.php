...
@section('pagetitle') Video Shoot - Edited and Recorded - Recording Studio Manchester @endsection

@section('pagedescription')
	
	<meta name="description" content="Looking to keep a memory from your popstar party at a recording studio near you? This is perfect - add to your party to improve your singing experience. No matter the occasion - keep the memory forever!" />
		...
		<div class="item_container tot_awe_pro_outer">
		    <div class="item_top  tot_awe_pro_left ">
		        <div class="item_thumb  user_product_img_thumb ">
		            <img alt="Get yourself ready for a professional video shoot with fully edited video" src="{{$commonMethods::getUserProductThumbnail($product->id)}}">
		        </div>
		    </div>
		    <div class="item_bottom  tot_awe_pro_right ">
		        <div class="item_info_box">
		            <div class="item_title">
		                <h1>Video Shoot - Professionally Edited and Recorded</h1>
		            </div>
		        </div>
		        ...
		        <section class="item_desc_each item_desc_expandable">
		            ...
		            <p class="item_desc_body">
		                Looking to keep a memory from your popstar party at a recording studio near you? This is perfect - add to your party to improve your singing experience. No matter the occasion - keep the memory forever!
		            </p>
		        </section>
