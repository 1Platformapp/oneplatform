...
@section('pagetitle') Musician Recording - Light Package - Recording Studio Manchester @endsection

@section('pagedescription')
	
	<meta name="description" content="Grab your guitar and head on down to our Recording Studio, where you can; play, sing, play your own song or even do a cover version, to any of our backing tracks" />
		...
		<div class="item_container tot_awe_pro_outer">
		    <div class="item_top  tot_awe_pro_left ">
		        <div class="item_thumb user_product_img_thumb ">
		            <img alt="All musicians are invited to compose and record their tunes and songs for 1 hr (Musicians Light Package)" src="{{$commonMethods::getUserProductThumbnail($product->id)}}">
		        </div>
		    </div>
		    <div class="item_bottom tot_awe_pro_right">
		        <div class="item_info_box">
		            <div class="item_title">
		                <h1>Musician Recording Package (Musicians Light Package)</h1>
		            </div>
		        </div>
		        ...
		        <section class="item_desc_each item_desc_expandable">
		            ...
		            <p class="item_desc_body">
		                Grab your guitar and head on down to our Recording Studio, where you can; play, sing, play your own song or even do a cover version, to any of our backing tracks.
 
		            </p><br>
		            <p class="item_desc_body">
		                We then work together to mix and master your track, as a special gift to take away from your studio day!
		            </p>
		        </section>
