                ...
                <table width="100%" cellspacing="0" cellpadding="0" border="0">
                    ...
                    <tr>
                        <td style="text-align:left" align="left">
                            <a style="margin: 0 auto 10px auto; font-size: 15px; color: #000; font-family: Open sans, sans-serif; letter-spacing: 1px; display: flex; align-items: center; text-decoration: none;" class="logo8" href="{{route('home')}}">
                                                    ...
                                                    <table cellspacing="0" cellpadding="0" border="0" align="center">
                                                        ...
                                                        <tr>
                                                            <td style="color:#8c8c8c;font-family:Open Sans,sans-serif;font-weight: 500;font-size:10px;width:100%;" align="center">
                                                                <a style="text-decoration: none; color: #000; font-size: 16px;" href="{{asset('reset/'.$token)}}">
                                        ...
                                        <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                            ...
                                            <tr>
                                                <td style="color:#9daec3;font-family:Helvetica,Arial,sans-serif;line-height:20px;font-size:14px;text-align:center">
                                                    ...
                                                    <p>
                                                        <a href="{{Config::get('constants.facebook_profile')}}"><img src="{{asset('email-template-images/purchase_email_facebook.png')}}" width="20"></a>
                                                        <a href="{{Config::get('constants.instagram_profile')}}"><img src="{{asset('email-template-images/purchase_email_instagram.png')}}" width="20"></a>
                                                        <a href="{{Config::get('constants.twitter_profile')}}"><img src="{{asset('email-template-images/purchase_email_twitter.png')}}" width="20"></a>
                                                    </p>
