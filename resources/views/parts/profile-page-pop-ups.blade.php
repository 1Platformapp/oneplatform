...
<div class="in_progress pro_page_pop_up clearfix" style="z-index: 10; display: block;" id="pro_fill_email">
...
<div class="pro_page_pop_up clearfix" style="z-index: 10; display: block;">
    <div class="pro_soc_con_face_inner clearfix">
        <div class="soc_con_top_logo clearfix">
            <a class="logo8"><img class="pro_soc_top_logo defer_loading" src="" data-src="{{ asset('images/1logo8.png') }}"><div>Platform</div></a>
...
<div class="pro_reset_password_secure pro_page_pop_up clearfix" id="change_pwd_secure_popup">
    ...
    <div class="pro_soc_discon_inner clearfix">
        ...
        <div class="pro_reset_password_inner stage_one clearfix">
        ...
        <div class="pro_reset_password_inner stage_two instant_hide clearfix">
...
<div class="pro_page_pop_up clearfix" id="share_project_popup" style="{{ $sharePopupDisplay }}" data-name="{{$user->name}}" data-share-image="{{$userCampaignVideoId}}">
...
<div class="pro_page_pop_up clearfix" style="z-index: 10;" id="agent_chat_locked">
...
<div class="add_video_to_channel pro_page_pop_up clearfix" id="post_video_popup_01">
    ...
    <div class="pro_soc_discon_inner clearfix">
        ...
        <div class="pro_select_item_before_procced_inner clearfix">
            ...
            <div class="pro_confirm_box_outer pro_submit_button_outer soc_con_submit_success clearfix" id="post_video_submit_yes">
...
<div class="pro_default_username in_progress pro_page_pop_up clearfix" style="z-index: 10;{{$suggestedUsername!=''?'display:block;' : ''}}" id="pro_default_username">
