                        ...
                        <div class="each_dash_section instant_hide" data-value="management-plan">
                            <div>
                                <div class="flex flex-col gap-4 mt-10">
                                    <button onclick="toggleProjectListVideo()" class="w-full px-4 py-2 font-semibold text-white bg-green-500 rounded cursor-pointer hover:bg-green-600 hover:font-bold md:w-1/3 lg:w-1/6 project_list_video_btn">Watch Explainer Video</button>
