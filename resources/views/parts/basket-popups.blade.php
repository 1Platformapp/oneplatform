    ...
    <div class="pro_confirm_delete_inner clearfix">
        ...
        <div class="soc_con_top_logo clearfix">
            ...
            <a style="opacity: 0;" class="logo8">
                <img alt="image popup" class="pro_soc_top_logo defer_loading" src="#" data-src="{{ asset('images/1logo8.png') }}">
                <div>Platform</div>
            </a>
...
<div class="pro_cannot_change_info pro_page_pop_up clearfix" id="login_before_apply_popup" style="z-index: 10;">
    ...
    <div class="pro_soc_discon_inner clearfix">
        ...
        <div class="pro_cannot_change_info_inner clearfix">
            ...
            <br /><img alt="image popup" class="show_icon prevent_pre_loading" src="#" data-src="{{ asset('images/pupfillprofile.png') }}">
            <div class="pro_submit_button_outer soc_con_submit_success clearfix" onclick="window.location.href='{{ asset("/") }}'">
