...
$(document).ready(function () {
    var displaylimit = 3;
    var twitterprofile = "ahsanhanif99";
	var screenname = "Ahsan Hanif";
    ...
    $.getJSON('/admin/test/testing-twitter/get_php.php', 
        function(feeds) {   
		   //alert(feeds);
            var feedHTML = '';
				...
				//console.log(feeds[i]);
				 ...
				 if (((showretweets == true) || ((isaretweet == false) && (showretweets == false))) && ((showdirecttweets == true) || ((showdirecttweets == false) && (isdirect == false)))) { 
					if ((feeds[i].text.length > 1) && (displayCounter <= displaylimit)) {             
						...
						feedHTML += '<div class="twitter-pic"><a href="https://twitter.com/'+tweetusername+'" target="_blank"><img src="'+profileimage+'"twitter-feed-icon.png" width="42" height="42" alt="twitter icon" /></a></div>';
