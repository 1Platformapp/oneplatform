...
$(document).ready(function() {
    ...
    $('body').delegate('.chat_member_remove', 'click', function(e){
        e.stopPropagation();
        var group = $(this).closest('.chat_each_group').attr('data-group');
        var member = $(this).closest('.chat_member_each_outer').attr('data-member');
        if(confirm('Are you sure?')){

            var formData = new FormData();
            formData.append('group', group);
            formData.append('contact', member);
    ...
    $('#send_add_chat_group_member').click(function(){

        var group = $('#add_chat_group_member_popup').attr('data-group');
        var contact = $('#add_chat_group_member').val();
