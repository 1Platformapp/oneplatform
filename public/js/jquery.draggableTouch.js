...
;(function($){
        ...
        this.each(function() {
            ...
            element.bind("touchmove.draggableTouch", function(e) {
                ...
                for (var i=0; i<orig.changedTouches.length; i++) {
                    ...
                    if((touch.pageX - offset.x) > 0 && ((touch.pageX - offset.x) + element.width()) <= (parent.width())){
                        $(this).css({
                            left: touch.pageX - offset.x
                        });
                    }
                    if((touch.pageY - offset.y) > 0 && ((touch.pageY - offset.y) + element.height()) <= (parent.height())){
                        $(this).css({
     ...
     */
    $.fn.draggableMouse = function (action, parent) {
        ...
        this.each(function() {
            ...
            var move = function(e) {
                ...
                if((e.pageX - offset.x) > 0 && ((e.pageX - offset.x) + element.width()) <= (parent.width())){
                    element.css({
                        left: e.pageX - offset.x,
                    });
                }
                if((e.pageY - offset.y) > 0 && ((e.pageY - offset.y) + element.height()) <= (parent.height())){
                    element.css({
