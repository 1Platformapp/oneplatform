...
//     var headerHTML = '';
//     var loadingHTML = '';
// alert(twitterprofile);
//     if( twitterprofile.length ){

//         headerHTML += '<div class="twitter_feed_head"><i class="fab fa-twitter"></i>';
//         headerHTML += '<a class="twitter-timeline" href="https://twitter.com/'+twitterprofile+'?ref_src=twsrc%5Etfw">Tweets by '+twitterprofile+'</a> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>';
