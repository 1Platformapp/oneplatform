...
Route::post('agent/reset-questionnaires', [AgentContactController::class, 'resetQuestionnaires'])->name('agent.reset.questionnaires');
...
Route::domain(Config::get('constants.primaryDomain'))->group(function () {
    ...
    Route::post('supporter-delete', [ProfileController::class, 'supporterDelete'])->name('user.supporter.delete');
